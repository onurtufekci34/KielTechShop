...
if (isset($_POST['add_to_cart'])) {
  $id_kunden = 1; // Kullanıcının ID'si (örneğin, sabit olarak 1 verildi)
  $id_produkt = $_POST['product_id']; // Ürünün ID'si, formdan alınacak
  $zahl = $_POST['zahl']; // Üründen kaç adet alındığı, formdan alınacak

  // Kontrol et: Aynı müşteri ve ürün kombinasyonu daha önce eklenmemişse ekle
...
$sql = "SELECT * FROM alle_produkte WHERE unter_k_id = 4";
                ...
                <div class="col-md-4">
                    <div class="card d-flex flex flex-column mb-4">
                        <div class="img-container">
                            <img src="imgs/grafikkarte/<?php echo $product['id_produkt']; ?>.png" class="card-img-top" alt="Product Image" />
                        </div>
