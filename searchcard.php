...
$sql = "SELECT * FROM alle_produkte WHERE Beschreibung OR p_name  LIKE '%$searchTerm%'";
                ...
                <div class="col-md-4">
                    <div class="card d-flex flex flex-column mb-4">
                        <div class="img-container">
                            <img src="imgs/<?php echo strtolower(getProductName($product['unter_k_id'])); ?>/<?php echo $product['id_produkt']; ?>.png" class="card-img-top" alt="Product Image" />
                        </div>
